...
dependencies {
    ...
    compile group: 'org.gitlab4j', name: 'gitlab4j-api', version: '6.0.0-rc.4-QREVIEW'
}
```
...
<dependency>
    ...
    <version>6.0.0-rc.4-QREVIEW</version>
</dependency>
```
...
```java
//DEPS org.gitlab4j:gitlab4j-api:6.0.0-rc.4-QREVIEW
```
